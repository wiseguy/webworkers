define([
    ...
    var RL = declare([Layer], {
        ...
        getDatasetRange: function() {
            ...
            if (rasterProps) {
                return {
                    min: rasterProps.datasetMin,
                    max: rasterProps.datasetMax
                };
            }
        },
        ...
        _drawRasterData: function() {
            ...
            var map = this._map;
            var lowerLeftCorner = new Point(data.xLLCenter - (size / 2), data.yLLCenter - (size / 2), new SpatialReference({
                wkid: 102100
            }));
            ...
            var cellWidth = number.round(dataWidth / numColumns),
                cellHeight = number.round(dataHeight / numRows);
